...
class LinearRegression_model(object):
	"""docstring for LinearRegression_model"""
	...
	def generate(self, 
		...
		if from_own:
			clf = LinearRegression(random_state = self.random_state,
	...
	def fit_model(self, features, labels, opt = True, num_cv = 3, params = None):
		...
		if opt:
			...
			self.mdl = self.hyperparam_optimise(features, 
				...
				model, 
				num_cv = num_cv)
#			self.mdl = LinearRegression(random_state = self.random_state,
